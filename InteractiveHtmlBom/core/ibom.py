...
def generate_file(pcb_file_dir, pcb_file_name, pcbdata, config):
    ...
    # schematic_file_path = os.path.join(bom_file_dir, 'sch-01.svg')
    #schematic_tag = '<img id="schematic-img" src="' + schematic_file_path + '">'
    # html = html.replace('///SCHEMATICDATA///', schematic_file_path)

    html = html.replace('///BOMFILEDIR///', bom_file_dir)
